class WelcomeController < ApplicationController
  ...
  def callback
    ...
    User.create(name: client.user.name, login: client.user.login, location: client.user.location, email: client.user.email, github_access_token: parsed_response["access_token"])
